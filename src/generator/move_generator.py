...
from src.generator.pieces.queen import Queen
...
class MoveGenerator:
    ...
    def get_queen_moves(self, bitboard, piece):
        if piece == PIECES["Q"] if self.side == SIDES["white"] else piece == PIECES["q"]:
            self.queen.generate_moves(bitboard)
